...
public class FriendsList extends ListActivity {
    ...
    protected void onListItemClick(ListView lv, View v, int position, long id) {
        ...
        Intent intent = new Intent(getApplicationContext(), FriendsEdit.class);
        intent.putExtras((Bundle) lv.getItemAtPosition(position));
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
       
        View view = Friends.group
        	.getLocalActivityManager()
        	.startActivity(getString(R.string.friends_edit_app), intent)
        	.getDecorView();
